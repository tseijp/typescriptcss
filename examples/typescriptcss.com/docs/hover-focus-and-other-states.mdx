...
{/* prettier-ignore */}
```tsx
<button style={px[5].py[2].bg['#0ea5e9'].rounded.full.hover.text['#fff'].bg['#0369a1']()}>
  Save changes
</button>
```
...
```tsx
<button
  style={px[5].py[2].text['#fff'].bg['#7c3aed'].rounded.full.hover.bg['#6d28d9'].focus.outline['#7c3aed'].active.bg['#5b21b6']()}
>
  Save changes
</button>
```
...
{/* prettier-ignore */}
```tsx
<li style={py[4].flex.first.pt[0].last.pb[0]()}>{/* ... */}</li>
```
...
```tsx
<input
  style={px[3].py[2].rounded.md.border['#d1d5db'].invalid.border['#ec4899'].invalid.text['#db2777'].focus.border['#0ea5e9'].disabled.bg['#f9fafb'].disabled.text['#9ca3af']()}
/>
```
...
{/* prettier-ignore */}
```tsx
<label style={p[4].gap[3].flex.items.center.rounded.lg.has.checked.bg['#eef2ff'].has.checked.text['#3730a3']()}>
...
{/* prettier-ignore */}
```tsx
<a style={group.block.p[8].bg['#0b1120'].rounded.lg()}>
...
{/* prettier-ignore */}
```tsx
<label style={peer.gap[3].flex.items.center()}>
  <input type="checkbox" />
