...
| `border.x.currentColor` | `border-inline-color: currentColor;`                                     |
...
| `border.y.currentColor` | `border-block-color: currentColor;`                                      |
...
| `border.s.currentColor` | `border-inline-start-color: currentColor;`                               |
...
| `border.e.currentColor` | `border-inline-end-color: currentColor;`                                 |
...
| `border.t.currentColor` | `border-block-start-color: currentColor;`                                |
...
| `border.b.currentColor` | `border-block-end-color: currentColor;`                                  |
...
| `border.r.currentColor` | `border-right-color: currentColor;`                                      |
...
| `border.l.currentColor` | `border-left-color: currentColor;`                                       |
