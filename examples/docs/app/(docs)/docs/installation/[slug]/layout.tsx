        ...
        return (
                <>
                        ...
                        <div style={gap[4].flex.col()}>
                                {guide.lead.map((line) => (
                                        <p key={line} style={m[0].max.w[180].text[4.5].text[color.muted].leading[8]()}>
                                                {line}
                                        </p>
                                ))}
                        </div>
                        ...
                        <div style={px[5].py[4].gap[4].flex.col.items.start.justify.between.bg[color.panel].rounded[3].border[color.border]()}>
                                ...
                                <Link href={callout.href} style={px[4].py[2].text[3.5].text[color.bg].font.semibold.bg[color.cyan].rounded.full.whiteSpace.nowrap.textDecoration.none()}>
                                        {callout.action}
                                </Link>
                        </div>
                </>
