import { color, dark as dark_, isNum, length, media, merge, numeric, px as px_, read, scope, set, side, space, token, withScope, x4 } from './utils'
...
export const gap = token<Utility['gap']>('gap', space('gap'))
