...
describe('max-width', () => {
	...
	test('container', () => {
		expect(_.container()).toEqual({ width: '100%', @media (width >= 40rem) { maxWidth: '40rem', }@media (width >= 48rem) { maxWidth: '48rem', }@media (width >= 64rem) { maxWidth: '64rem', }@media (width >= 80rem) { maxWidth: '80rem', }@media (width >= 96rem) { maxWidth: '96rem' })
	})
})
