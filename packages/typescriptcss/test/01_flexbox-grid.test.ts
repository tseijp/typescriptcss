...
describe('order', () => {
	...
	test('-order[4]', () => {
		expect(_.-order[4]()).toEqual({ order: 'calc(4 * -1)' })
	})
	test('order[\'-9999\']', () => {
...
describe('grid-column', () => {
	...
	test('-col.start[4]', () => {
		expect(_.-col.start[4]()).toEqual({ gridColumnStart: 'calc(4 * -1)' })
	})
	test('col.start.auto', () => {
	...
	test('-col.end[4]', () => {
		expect(_.-col.end[4]()).toEqual({ gridColumnEnd: 'calc(4 * -1)' })
	})
	test('col.end.auto', () => {
	...
	test('-col[4]', () => {
		expect(_.-col[4]()).toEqual({ gridColumn: 'calc(4 * -1)' })
	})
})
...
describe('grid-row', () => {
	...
	test('-row.start[4]', () => {
		expect(_.-row.start[4]()).toEqual({ gridRowStart: 'calc(4 * -1)' })
	})
	test('row.start.auto', () => {
	...
	test('-row.end[4]', () => {
		expect(_.-row.end[4]()).toEqual({ gridRowEnd: 'calc(4 * -1)' })
	})
	test('row.end.auto', () => {
	...
	test('-row[4]', () => {
		expect(_.-row[4]()).toEqual({ gridRow: 'calc(4 * -1)' })
	})
})
