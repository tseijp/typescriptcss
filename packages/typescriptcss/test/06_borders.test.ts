...
describe('border-width', () => {
	...
	test('divide.x', () => {
		expect(_.divide.x()).toEqual({ & >: 'not(:last-child) {  border-inline-start-width: 0px', borderInlineEndWidth: '1px' })
	})
	test('divide.x[4]', () => {
		expect(_.divide.x[4]()).toEqual({ & >: 'not(:last-child) {  border-inline-start-width: 0px', borderInlineEndWidth: '4px' })
	})
	test('divide.y', () => {
		expect(_.divide.y()).toEqual({ & >: 'not(:last-child) {  border-top-width: 0px', borderBottomWidth: '1px' })
	})
	test('divide.y[4]', () => {
		expect(_.divide.y[4]()).toEqual({ & >: 'not(:last-child) {  border-top-width: 0px', borderBottomWidth: '4px' })
	})
})
...
describe('border-color', () => {
	...
	test('divide.inherit', () => {
		expect(_.divide.inherit()).toEqual({ & >: 'not(:last-child) {  border-color: inherit' })
	})
	test('divide.current', () => {
		expect(_.divide.current()).toEqual({ & >: 'not(:last-child) {  border-color: currentColor' })
	})
	test('divide.transparent', () => {
		expect(_.divide.transparent()).toEqual({ & >: 'not(:last-child) {  border-color: transparent' })
	})
	test('divide[4]', () => {
		expect(_.divide[4]()).toEqual({ & >: 'not(:last-child) {  border-color: 4' })
	})
})
...
describe('border-style', () => {
	...
	test('divide.solid', () => {
		expect(_.divide.solid()).toEqual({ & >: 'not(:last-child) {  border-style: solid' })
	})
	test('divide.dashed', () => {
		expect(_.divide.dashed()).toEqual({ & >: 'not(:last-child) {  border-style: dashed' })
	})
	test('divide.dotted', () => {
		expect(_.divide.dotted()).toEqual({ & >: 'not(:last-child) {  border-style: dotted' })
	})
	test('divide.double', () => {
		expect(_.divide.double()).toEqual({ & >: 'not(:last-child) {  border-style: double' })
	})
	test('divide.hidden', () => {
		expect(_.divide.hidden()).toEqual({ & >: 'not(:last-child) {  border-style: hidden' })
	})
	test('divide.none', () => {
		expect(_.divide.none()).toEqual({ & >: 'not(:last-child) {  border-style: none' })
	})
})
...
describe('outline-offset', () => {
	...
	test('-outline.offset[4]', () => {
		expect(_.-outline.offset[4]()).toEqual({ outlineOffset: 'calc(4px * -1)' })
	})
})
